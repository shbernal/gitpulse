...
describe("completion commands", () => {
  test("generates the expected Bash hooks", () => {
    ...
    expect(script).toContain("docs web star unstar starred search user forks history cache config completions");
    ...
    expect(script).toContain("docs|web|star|unstar|forks");
